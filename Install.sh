...
#  gunzip ./data/hg19_ljb26_all_converted.vcf.gz
#fi
wget http://122.112.206.160/XCNV/data/hg19_ljb26_all_converted_scores.txt -O ./data/hg19_ljb26_all_converted_scores.txt
wget http://122.112.206.160/XCNV/data/hg19_ljb26_all_converted_sites.vcf -O ./data/hg19_ljb26_all_converted_sites.vcf
wget http://122.112.206.160/XCNV/data/CDTS_percentile.txt -O ./data/CDTS_percentile.txt
wget http://122.112.206.160/XCNV/data/merged.cnv.sample.info.txt -O ./data/merged.cnv.sample.info.txt
 wget http://122.112.206.160/XCNV/data/merged.cnv.data.output.csv -O ./data/merged.cnv.data.output.csv
